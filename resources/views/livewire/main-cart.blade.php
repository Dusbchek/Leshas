<div> <h1 class="text-center text-4xl font-black mt-8">Carrito de compra</h1>
    <div class="grid grid-cols-1  md:flex mx-auto justify-center mt-8">
        <div class="grid grid-cols-1">  
            ...
            @foreach($cartItems as $item)
                ...
                <div class="flex flex-row  ">
                    <div class="card border-[1px] border-gray-200 rounded-2xl shadow-lg p-4    mt-3 mx-auto ">
        ...
        <div class="card border-[1px] border-gray-200 rounded-2xl shadow-2xl p-4 w-[400px] h-80  mt-3 md:ml-14">
            ...
            <div class="flex flex-row ml-5 mt-8">
                ...
                <h1 class=" text-2xl font-bold ml-auto mr-5">${{ $total + $ship}} </h1>
            </div>
